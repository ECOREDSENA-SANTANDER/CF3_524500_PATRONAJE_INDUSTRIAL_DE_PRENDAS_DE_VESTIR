...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center(data-aos="fade-left").py-4
      .col-lg-4.col-8
        img(src='@/assets/curso/temas/tema2/img02.png', alt='').py-4
      .col-lg-8
    ...
    p.py-2 En este punto, para la implementación de los básicos se debe tomar como referencia los pasos del patronaje de acuerdo con la metodología SENA.

    h4.py-2 Pasos del patronaje – implementación de básicos y desarrollo de modelos
    ...
    Separador  
    #t_2_1_1.titulo-segundo.color-primario
      h2 2.1.1 Camisa #[em slim fit]
    ...
    Separador  
    #t_2_1_2.titulo-segundo.color-primario
      h2 2.1.2 Trazo de manga, puño y cuello – camisa clásica y #[em slim fit]
      ...
      SlyderA(tipo="a")
        .row.justify-content-center(data-aos="fade-left")
          .col-md-5.mb-3.mb-md-0.p-4
            img(src='@/assets/curso/temas/tema2/img07.svg', alt='')
        
        .row.justify-content-center(data-aos="fade-left")
          .col-md-5.mb-3.mb-md-0.p-4
            img(src='@/assets/curso/temas/tema2/img08.svg', alt='')
        
        .row.justify-content-center(data-aos="fade-left")
          .col-md-5.mb-3.mb-md-0.p-4
            img(src='@/assets/curso/temas/tema2/img09.svg', alt='')
    ...
    p En el caso de las cabezas de mangas deducidas para las camisas clásica y slim fit se sugiere trabajar con:
    .py-2
    .row.justify-content-center(data-aos="fade-left")
      .col-lg-8
        .tarjeta-avatar-b.mb-5
    ...
    figure.mb-5(data-aos="zoom-in-left")
      ...
      .row.justify-content-center.align-items-center(data-aos="fade-left").py-4
        .col-lg-4.col-8
          img(src='@/assets/curso/temas/tema2/img22.svg', alt='').py-4
        .col-lg-8
    ...
    .py-2
    p El rectángulo siempre se traza con las medidas más protuberantes correspondientes a la talla:
    ...
    .row.justify-content-center(data-aos="fade-left")
      ...
      .row.justify-content-center.align-items-center(data-aos="fade-left")
        ...
        .col-lg-10
          p Para lograr apropiar la metodología desde el inicio se sugiere ir bautizando cada línea que se traza con la parte del cuerpo que se está trabajando, esto ayudará a entender el paso de la figura 3D (cuerpo, persona) al plano 2D (trazo)
          p para el desarrollo de la base se sugiere seguir el paso del trazo de básicos superiores masculino, ajustando o aplicando las medidas de las fórmulas para la base sastre masculina.
    .py-4
    figure.mb-5(data-aos="zoom-in-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/Zlc9gtFlJLw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
